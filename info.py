...
BOT_TOKEN = environ.get('BOT_TOKEN', "6944321558:AAEM_enEZ_sZn63dBOx4czYCJU0X3E7EW6o")
...
PICS = (environ.get('PICS', 'https://telegra.ph/file/66ce20af65eb74ebf6442.jpg')).split()
...
NOR_IMG = environ.get("NOR_IMG", "https://telegra.ph/file/cc0ebbe5c00cb94a0c317.jpg")
MELCOW_VID = environ.get("MELCOW_VID", "https://telegra.ph/file/451f038b4e7c2ddd10dc0.mp4")
SPELL_IMG = environ.get("SPELL_IMG", "https://telegra.ph/file/cc0ebbe5c00cb94a0c317.jpg")

# Admins, Channels & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '560951157 6699419336').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002001794910').split()]
...
# MongoDB information
SECONDDB_URI = environ.get('SECONDDB_URI', "mongodb+srv://steverogerz100:steverogerz@cluster0.1fovda9.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://filetesd:filetesd@cluster0.u7crpq5.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002019800159'))
